...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  //Agregar tiempos a procesos
    do {
        $fecha=date('Y-m-d H:i:s', strtotime($fecha)+3600*$row_TiemposID1[$cliente_act]);
        $proc=$row_TiemposID1['Proceso'];

        $insertSQL1 = sprintf("INSERT INTO Procesos (Placa, Proceso, FEsperada) VALUES (%s, %s, %s)",
                       GetSQLValueString($_POST['Placa'], "text"),
